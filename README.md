...
[![Maven Central](https://img.shields.io/badge/maven%20central-3.0.0--b1-brightgreen.svg)](http://search.maven.org/#artifactdetails|com.github.os72|protoc-jar|3.0.0-b1|)
...
#### Usage - executable
```
$ java -jar protoc-jar-3.0.0-b1.jar -v2.4.1 --version
...
$ java -jar protoc-jar-3.0.0-b1.jar -v2.5.0 --version
...
$ java -jar protoc-jar-3.0.0-b1.jar -v2.6.1 --version
...
$ java -jar protoc-jar-3.0.0-b1.jar -v3.0.0 --version
