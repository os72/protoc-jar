...
Available on Maven Central: http://central.maven.org/maven2/com/github/os72/protoc-jar/3.1.0.2/

[![Maven Central](https://img.shields.io/badge/maven%20central-3.1.0.2-brightgreen.svg)](http://search.maven.org/#artifactdetails|com.github.os72|protoc-jar|3.1.0.2|)
...
#### Usage - executable
```
$ java -jar protoc-jar-3.1.0.2.jar -v2.4.1 --version
...
$ java -jar protoc-jar-3.1.0.2.jar -v2.5.0 --version
...
$ java -jar protoc-jar-3.1.0.2.jar -v2.6.1 --version
...
$ java -jar protoc-jar-3.1.0.2.jar -v3.1.0 --version
...
$ java -jar protoc-jar-3.1.0.2.jar -v:com.google.protobuf:protoc:3.1.0 --version
...
```
$ java -jar protoc-jar-3.1.0.2.jar --include_std_types -I. --java_out=out StdTypeExample.proto
protoc-jar: protoc version: 310, detected platform: windows 8/amd64
...
```
$ java -jar protoc-jar-3.1.0.2.jar -v2.4.1 --java_shaded_out=out PersonSchema.proto
protoc-jar: protoc version: 241, detected platform: windows 8/amd64
