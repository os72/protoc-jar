...
[![Maven Central](https://img.shields.io/badge/maven%20central-3.0.0-brightgreen.svg)](http://search.maven.org/#artifactdetails|com.github.os72|protoc-jar|3.0.0|)
...
#### Usage - executable
```
$ java -jar protoc-jar-3.0.0.jar -v2.4.1 --version
...
$ java -jar protoc-jar-3.0.0.jar -v2.5.0 --version
...
$ java -jar protoc-jar-3.0.0.jar -v2.6.1 --version
...
$ java -jar protoc-jar-3.0.0.jar -v3.0.0 --version
...
```
$ java -jar protoc-jar-3.0.0.jar -v2.4.1 --java_shaded_out=out PersonSchema.proto
protoc-jar: protoc version: 241, detected platform: windows 8/amd64
