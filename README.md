...
Simple convenience JAR that embeds protoc compiler binaries for Linux, Mac/OSX, and Windows. See the the Protocol Buffers site for details: https://code.google.com/p/protobuf/
